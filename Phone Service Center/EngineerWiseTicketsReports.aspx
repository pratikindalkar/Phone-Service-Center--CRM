<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EngineerWiseTicketsReports.aspx.cs" Inherits="Phone_Service_Center.EngineerWiseTicketsReports" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <h2>Engineer Wise Ticket Reports</h2>
        <style>
        .modalPopup {
            display: none; 
            position: fixed;
    ...
    <asp:GridView ID="GridViewEngineers" runat="server" AutoGenerateColumns="false" OnRowCommand="GridViewEngineers_RowCommand" CssClass="table table-striped table-bordered">
        <Columns>
            <asp:TemplateField HeaderText="Engineer Name" ItemStyle-Width="180px">
                <ItemTemplate>
            ...
            <asp:TemplateField HeaderText="Actions" ItemStyle-Width="100px">
                <ItemTemplate>
                    <asp:Button ID="btnView" runat="server" Text="View"
                        CommandName="ShowDetails" CommandArgument='<%# Eval("EngineerID") %>' CssClass="btn btn-warning btn-sm" />
                </ItemTemplate>
            </asp:TemplateField>
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                <div class="modalContent">
                    ...
                    <asp:Button ID="btnClosePopup" runat="server" Text="Close" CssClass="btn btn-warning btn-sm" OnClientClick="hideModal(); return false;" />
                </div>
                <!-- End of modalContent -->
            </ContentTemplate>
        </asp:UpdatePanel>
    ...
    <asp:HiddenField ID="hdnSelectedEngineer" runat="server" />
</asp:Content>
